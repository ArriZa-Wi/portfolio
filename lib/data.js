export const PORTFOLIO_DATA = {
  ...
  tagline: "Co-founder of Electric Trident and a tinkerer with anything that ships: AI platforms, e-commerce backends, accessible web apps, and the servers they run on.",
  ...
  featured: [
    {
      ...
      blurb: "A full-stack portal where real-estate agents buy credit bundles and send personalized, laser-engraved gifts to their clients through a guided ordering wizard. Shopify runs headless underneath as the payment and order backend. It runs in production for the client.",
      details: [
  ...
  experience: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Built a Python orchestration and analysis toolchain from scratch (config generation, device-readiness checks, automated sweeps, results reporting)."
      ]
    },
    {
      role: "Research Programmer",
